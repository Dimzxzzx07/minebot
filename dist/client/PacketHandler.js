...
class PacketHandler extends events_1.EventEmitter {
    connection;
    logger;
    botState;
    packetStats;
    osintMode;
    constructor(connection, osintMode = false) {
        super();
    ...
    sendPosition(position, onGround = true) {
